...
type JcodeKnownToolName = keyof typeof TOOL_NAME_MAP;

function isPlainObject(value: unknown): value is Record<string, unknown> {
  return value !== null && typeof value === 'object' && !Array.isArray(value);
}

function isKnownToolName(value: unknown): value is JcodeKnownToolName {
...
function toKnownToolName(value: string | undefined): JcodeKnownToolName | null {
  if (!value) {
    return null;
  }
...
export function resolveJcodeRawToolName(
...
export function normalizeJcodeToolName(rawName: string | undefined): string {
...
export function normalizeJcodeToolInput(
...
export function normalizeJcodeToolUseResult(
  rawName: string | undefined,
  input: Record<string, unknown>,
  rawOutput: unknown,
...
export function createJcodeToolStreamAdapter(): AcpToolStreamAdapter {
  return new AcpToolStreamAdapter({
    normalizeToolInput: normalizeJcodeToolInput,
    normalizeToolName: normalizeJcodeToolName,
    normalizeToolUseResult: normalizeJcodeToolUseResult,
    resolveRawToolName: resolveJcodeRawToolName,
  });
}
